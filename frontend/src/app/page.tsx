...
export default function LandingPage() {
  return (
    <main className="flex-1 bg-paper">
      ...
      {/* Hero */}
      <section className="mx-auto grid max-w-[1240px] grid-cols-1 gap-12 px-4 sm:px-8 py-20 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
      ...
      <section className="border-y-2 border-ink bg-accent-soft py-4">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-center gap-x-10 gap-y-2 px-4 sm:px-8 text-center text-sm font-bold">
      ...
      {/* How it works */}
      <section id="how-it-works" className="mx-auto max-w-[1240px] px-4 sm:px-8 py-20">
      ...
      <section className="mx-auto max-w-[1240px] px-4 sm:px-8 py-10">
      ...
      {/* Pricing teaser */}
      <section className="mx-auto max-w-[1240px] px-4 sm:px-8 py-14">
      ...
      <footer className="border-t-2 border-ink">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-between gap-4 px-4 sm:px-8 py-6 text-[13px] text-muted">
          <span>© Seovate</span>
